...
parse.line = (line, version) => {
  ...
  //this is bad. names can contain spaces.
  l = line.split(' ')
  ...
  o.date.setMonth(l[0].split('/')[0] - 1)
  o.date.setDate(l[0].split('/')[1])
  o.date.setHours(l[1].split(':')[0])
  o.date.setMinutes(l[1].split(':')[1])
  o.date.setSeconds(l[1].split(':')[2].split('.')[0])
  o.date.setMilliseconds(l[1].split(':')[2].split('.')[1])
